...
export const DrumPad = ({letter,sound, keyCode, handlePadClick}) => {
  ...
  return (
    <div data-key={keyCode}  className='key p-2 w-[100px] md:p-3  md:w-[100px] md:h-[100px] border-2 border-blue-600 rounded justify-center items-center flex flex-col z-10 bg-yellow-300 opacity-2 transfrom cursor-pointer transition-transform duration-100' onClick={() => playSound(keyCode)}>
